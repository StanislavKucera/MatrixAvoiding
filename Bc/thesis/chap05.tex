...
If user wants to define their own statistics, they can add variables into the class, alter ``add\_data'' function to allow storing the desired data and change function ``print\_$\cdots$'' to define the output.
